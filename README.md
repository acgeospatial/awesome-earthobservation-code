...
* [Remote Sening with Python in Jupyter](https://www.youtube.com/watch?v=OsgZSlv4t) - n this video we're looking at using Google Earth Engine in Jupyter with the Python API.
